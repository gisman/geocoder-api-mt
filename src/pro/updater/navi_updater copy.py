...
class NaviUpdater(BaseUpdater):
    ...
    def cache_navi_dic_mem(self, navi_dic):
        ...
        self.navi_dic[navi_dic["bld_mgt_no"]] = {
            k: v for k, v in navi_dic.items() if k in NAVI_CACHE_COLS
        }
    ...
    def prepare_dic_jibun(self, value):
        ...
        d = {
            ...
            "ri_nm": value["리명"],
            "road_nm": d_navi.get("road_nm"),
            "undgrnd_yn": d_navi.get("undgrnd_yn"),
            "bld1": d_navi.get("bld1"),
            "bld2": d_navi.get("bld2"),
            "san": value["산여부"],
            "bng1": value["지번본번"],
            "bng2": value["지번부번"],
            ...
            "ld_cd": value["법정동코드"],
            "hd_cd": d_navi.get("hd_cd") or value.get("주소관할읍면동코드"),
            "road_cd": d_navi.get("road_cd"),
            "zip": d_navi.get("zip"),
